    ...
    <section id="overview" part="section-overview"
      ...
      ${null!==(e=this.resolvedSpec)&&void 0!==e&&e.info?q`
          ...
          <div id="api-info" style="font-size:calc(var(--font-size-regular) - 1px); margin-top:8px;">
            ...
            ${null!==(r=this.resolvedSpec.info.contact)&&void 0!==r&&r.url?q`<span>URL: <a href="${this.resolvedSpec.info.contact.url}" part="anchor anchor-overview" target="_blank">${this.resolvedSpec.info.contact.name}</a></span>`:""}
